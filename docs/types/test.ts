...
{
	random( [ 3, 3 ], 2, 5.0 ); // $ExpectType RandomArray
	random( [ 3, 3 ], 2, 5.0, {} ); // $ExpectType RandomArray
}
...
{
	random( [ 3, 3 ], '5', 5.0 ); // $ExpectError
	random( [ 3, 3 ], true, 5.0 ); // $ExpectError
	random( [ 3, 3 ], false, 5.0 ); // $ExpectError
	random( [ 3, 3 ], null, 5.0 ); // $ExpectError
	random( [ 3, 3 ], [], 5.0 ); // $ExpectError
	random( [ 3, 3 ], {}, 5.0 ); // $ExpectError
	random( [ 3, 3 ], ( x: number ): number => x, 5.0 ); // $ExpectError
...
{
	random( [ 3, 3 ], 2, '5' ); // $ExpectError
	random( [ 3, 3 ], 2, true ); // $ExpectError
	random( [ 3, 3 ], 2, false ); // $ExpectError
	random( [ 3, 3 ], 2, null ); // $ExpectError
	random( [ 3, 3 ], 2, [] ); // $ExpectError
	random( [ 3, 3 ], 2, {} ); // $ExpectError
	random( [ 3, 3 ], 2, ( x: number ): number => x ); // $ExpectError
...
{
	random( [ 3, 3 ], 2, 5.0, '5' ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, 5 ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, true ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, false ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, [] ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, ( x: number ): number => x ); // $ExpectError
}

// The compiler throws an error if the function is provided a `dtype` option which is not a supported data type...
{
	random( [ 3, 3 ], 2, 5.0, { 'dtype': 123 } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'dtype': 'abc' } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'dtype': null } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'dtype': [] } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'dtype': {} } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'dtype': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function is provided an invalid `order` option...
{
	random( [ 3, 3 ], 2, 5.0, { 'order': 123 } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'order': 'abc' } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'order': null } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'order': [] } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'order': {} } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'order': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function is provided an invalid `mode` option...
{
	random( [ 3, 3 ], 2, 5.0, { 'mode': 123 } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'mode': 'abc' } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'mode': null } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'mode': [] } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'mode': {} } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'mode': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function is provided an invalid `submode` option...
{
	random( [ 3, 3 ], 2, 5.0, { 'submode': 123 } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'submode': 'abc' } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'submode': null } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'submode': [ '1' ] } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'submode': {} } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'submode': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function is provided an invalid `readonly` option...
{
	random( [ 3, 3 ], 2, 5.0, { 'readonly': 123 } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'readonly': 'abc' } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'readonly': null } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'readonly': [] } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'readonly': {} } ); // $ExpectError
	random( [ 3, 3 ], 2, 5.0, { 'readonly': ( x: number ): number => x } ); // $ExpectError
}
...
// Attached to the main export is an `assign` method which returns an ndarray...
{
	...
	random.assign( 2, 5.0, arr ); // $ExpectType float64ndarray
}
...
// The compiler throws an error if the `assign` method is provided a first argument which is not a number or ndarray...
{
	...
	random.assign( '5', 5.0, arr ); // $ExpectError
	random.assign( true, 5.0, arr ); // $ExpectError
	random.assign( false, 5.0, arr ); // $ExpectError
	random.assign( null, 5.0, arr ); // $ExpectError
	random.assign( [], 5.0, arr ); // $ExpectError
	random.assign( {}, 5.0, arr ); // $ExpectError
	random.assign( ( x: number ): number => x, 5.0, arr ); // $ExpectError
}
...
// The compiler throws an error if the `assign` method is provided a second argument which is not a number or ndarray...
{
	...
	random.assign( 2, '5', arr ); // $ExpectError
	random.assign( 2, true, arr ); // $ExpectError
	random.assign( 2, false, arr ); // $ExpectError
	random.assign( 2, null, arr ); // $ExpectError
	random.assign( 2, [], arr ); // $ExpectError
	random.assign( 2, {}, arr ); // $ExpectError
	random.assign( 2, ( x: number ): number => x, arr ); // $ExpectError
}
...
// The compiler throws an error if the `assign` method is provided a third argument which is not an ndarray...
{
	...
	random.assign( 2, 5.0, [ '1' ] ); // $ExpectError
...
// The compiler throws an error if the `assign` method is provided an unsupported number of arguments...
{
	...
	random.assign( 2 ); // $ExpectError
	random.assign( 2, 5.0 ); // $ExpectError
	random.assign( 2, 5.0, arr, {} ); // $ExpectError
}
...
// The `factory` method returns a function which returns an ndarray...
{
	...
	fcn1( [ 3, 3 ], 2, 5.0 ); // $ExpectType RandomArray

	const fcn2 = random.factory( {} );
	fcn2( [ 3, 3 ], 2, 5.0 ); // $ExpectType RandomArray
}
...
{
	const fcn1 = random.factory();
	fcn1( true, 2, 5.0 ); // $ExpectError
	fcn1( false, 2, 5.0 ); // $ExpectError
	fcn1( '5', 2, 5.0 ); // $ExpectError
	fcn1( [ '1' ], 2, 5.0 ); // $ExpectError
	fcn1( {}, 2, 5.0 ); // $ExpectError
	fcn1( ( x: number ): number => x, 2, 5.0 ); // $ExpectError
	...
	fcn1( [ 3, 3 ], true, 5.0 ); // $ExpectError
	fcn1( [ 3, 3 ], false, 5.0 ); // $ExpectError
	fcn1( [ 3, 3 ], '5', 5.0 ); // $ExpectError
	fcn1( [ 3, 3 ], [], 5.0 ); // $ExpectError
	fcn1( [ 3, 3 ], {}, 5.0 ); // $ExpectError
	fcn1( [ 3, 3 ], ( x: number ): number => x, 5.0 ); // $ExpectError
	...
	fcn1( [ 3, 3 ], 2, true ); // $ExpectError
	fcn1( [ 3, 3 ], 2, false ); // $ExpectError
	fcn1( [ 3, 3 ], 2, '5' ); // $ExpectError
	fcn1( [ 3, 3 ], 2, [] ); // $ExpectError
	fcn1( [ 3, 3 ], 2, {} ); // $ExpectError
	fcn1( [ 3, 3 ], 2, ( x: number ): number => x ); // $ExpectError
...
// The compiler throws an error if the function returned by the `factory` method is provided a `dtype` option which is not a supported data type...
{
	...
	fcn( [ 3, 3 ], 2, 5.0, { 'dtype': 123 } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'dtype': 'abc' } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'dtype': null } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'dtype': [] } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'dtype': {} } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'dtype': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function returned by the `factory` method is provided an invalid `order` option...
{
	const fcn = random.factory();
	fcn( [ 3, 3 ], 2, 5.0, { 'order': 123 } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'order': 'abc' } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'order': null } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'order': [] } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'order': {} } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'order': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function returned by the `factory` method is provided an invalid `mode` option...
{
	const fcn = random.factory();
	fcn( [ 3, 3 ], 2, 5.0, { 'mode': 123 } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'mode': 'abc' } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'mode': null } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'mode': [] } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'mode': {} } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'mode': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function returned by the `factory` method is provided an invalid `submode` option...
{
	const fcn = random.factory();
	fcn( [ 3, 3 ], 2, 5.0, { 'submode': 123 } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'submode': 'abc' } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'submode': null } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'submode': [ '1' ] } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'submode': {} } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'submode': ( x: number ): number => x } ); // $ExpectError
}

// The compiler throws an error if the function returned by the `factory` method is provided an invalid `readonly` option...
{
	const fcn = random.factory();
	fcn( [ 3, 3 ], 2, 5.0, { 'readonly': 123 } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'readonly': 'abc' } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'readonly': null } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'readonly': [] } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'readonly': {} } ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, { 'readonly': ( x: number ): number => x } ); // $ExpectError
}
...
// The compiler throws an error if the function returned by the `factory` method is provided an unsupported number of arguments...
{
	...
	fcn(); // $ExpectError
	fcn( [ 3, 3 ] ); // $ExpectError
	fcn( [ 3, 3 ], 2 ); // $ExpectError
	fcn( [ 3, 3 ], 2, 5.0, {}, {} ); // $ExpectError
}

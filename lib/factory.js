...
var base = require( '@stdlib/random-base-erlang' );
...
/**
* Returns a function for generating pseudorandom numbers drawn from an Erlang distribution.
*
* @name factory
* @type {Function}

...
interface RandomFunction extends PRNG {
	/**
	* Returns an ndarray containing pseudorandom numbers drawn from an Erlang distribution.
	*
	...
	*/
	<T extends typedndarray<number>, U extends typedndarray<number>>( shape: Shape, k: number | T, lambda: number | U, options?: Options ): RandomArray;

	/**
	* Fills an ndarray with pseudorandom numbers drawn from an Erlang distribution.
	*
	* @param k - shape parameter
	* @param lambda - rate parameter
	...
	* @returns output ndarray
	*/
	assign<T extends typedndarray<number>, U extends typedndarray<number>, V extends typedndarray<number>>( k: number | T, lambda: number | U, out: V ): V;
}
...
interface Random extends PRNG {
	...
	*/
	...
	/**
	* Returns a function for creating ndarrays containing pseudorandom numbers drawn from an Erlang distribution.
	*
	* @param options - function options

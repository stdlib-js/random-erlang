...
> Generate pseudorandom numbers drawn from an [Erlang][@stdlib/random/base/erlang] distribution.
...
```javascript
erlang = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-erlang@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-erlang/tags). For example,

```javascript
erlang = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-erlang@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var erlang = require( 'path/to/vendor/umd/random-erlang/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-erlang@umd/browser.js"></script>
```
...
#### erlang( shape, k, lambda\[, options] )

Returns an [ndarray][@stdlib/ndarray/ctor] containing pseudorandom numbers drawn from an [Erlang][@stdlib/random/base/erlang] distribution.

```javascript
var arr = erlang( [ 3, 3 ], 2, 5.0 );
// returns <ndarray>
```
...
Fills an [ndarray][@stdlib/ndarray/ctor] with pseudorandom numbers drawn from an [Erlang][@stdlib/random/base/erlang] distribution.
...
#### erlang.factory( \[options] )

Returns a function for generating pseudorandom numbers drawn from an [Erlang][@stdlib/random/base/erlang] distribution.
...
var random = erlang.factory( opts );
...
The function returned by the `factory` method has the same interface and accepts the same options as the `erlang` function above.
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-erlang.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-erlang

[test-image]: https://github.com/stdlib-js/random-erlang/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/random-erlang/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-erlang/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-erlang?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-erlang.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-erlang/main
...
[deno-url]: https://github.com/stdlib-js/random-erlang/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-erlang/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-erlang/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-erlang/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-erlang/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-erlang/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-erlang/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-erlang/main/LICENSE

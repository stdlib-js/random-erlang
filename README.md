...
```javascript
erlang = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-erlang@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/random-erlang/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/random-erlang/actions/workflows/test.yml?query=branch:v0.1.1
